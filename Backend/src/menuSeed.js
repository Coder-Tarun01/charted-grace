  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        items: ["NRI Tax Advisory", "NRI Capital Gain Advisory", "Double Taxation Avoidance Agreement (DTAA)"],
      },
      {
        title: "Indirect Taxes (GST)",
        items: ["GST Return Filing", "GST Advisory", "GST Refund Process", "GST Audit", "GST LUT Filing"],
      },
      {
        title: "Customs & Excise",
        items: ["Customs Duty Valuation", "Excise Tax Compliance", "Anti-Dumping Duty Analysis"],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        items: ["Add a Partner", "Resignation of a Partner", "Alteration of LLP Deed", "Closure / Revival of LLPs", "Annual Filings of LLP"],
      },
      {
      ...
      },
      {
        ...
        items: ["NGO Compliance", "Section 8 Compliance", "CSR-1 Filing", "Section 80G & Section 12A Registration", "Darpan Registration", "FCRA Registration"],
      },
    ],
  },
];
